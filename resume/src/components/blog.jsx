			...
			<div className="colorlib-narrow-content">
				...
				<div className="row">
					...
					<div className="blog-entry">
						...
						<div className="desc">
							<span><small></small> | <small> Web Design </small> | <small> <i className="icon-bubble3" /> 4</small></span>
						</div>
					</div>
					</div>
					...
					<div className="blog-entry">
						...
						<div className="desc">
							<span><small></small> | <small> Inspiration </small> | <small> <i className="icon-bubble3" /> 4</small></span>
						</div>
					</div>
					</div>
				</div>
